...
import { closeModalUpdateMovie } from '../../../../redux/slice/modelUpdateMovie';
...
const ModalUpdateMovie = () => {
  ...
  const isOpen = useSelector((state) => state.modalUpdateMovie.isOpen);
  const movieId = useSelector((state) => state.modalUpdateMovie.movieId);

  const handleCloseDialog = () => {
    dispatch(closeModalUpdateMovie(movieId));
  };
  ...
  return (
    <div className='modal_Update_Movie'>
        {isOpen && (
